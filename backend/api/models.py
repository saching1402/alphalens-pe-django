...
class FundManager(models.Model):
    ...
    pb_score=models.DecimalField(max_digits=5,decimal_places=2,null=True,blank=True)
...
class Fund(models.Model):
    ...
    sector_focus=models.CharField(max_length=200,null=True,blank=True)
    created_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now=True)
    class Meta:
        db_table='funds'
...
class Workflow(models.Model):
    STATUS_CHOICES=[('Due Diligence','Due Diligence'),('Committed','Committed'),('Declined','Declined'),('Watchlist','Watchlist'),('Open','Open'),('In Progress','In Progress'),('Resolved','Resolved'),('Closed','Closed')]
    TYPE_CHOICES=[('Due Diligence','Due Diligence'),('Clarification','Clarification'),('Risk Review','Risk Review'),('Performance','Performance'),('Other','Other')]
